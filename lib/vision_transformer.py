...
* Trained (supervised on ImageNet-1k) my custom 'small' patch models to 77.9, 'base' to 79.4 top-1 with this code.
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        self.proj_depth = nn.Conv2d(1, embed_dim, kernel_size=patch_size, stride=patch_size)
    ...
    def forward(self, x):
        ...
        if C == 1:
            x = self.proj_depth(x).flatten(2).transpose(1, 2)
        else:
